...
if [ $# -le 4 ] ; then
  ...
  exit ;
		...
		#
		# SERVER VARIABLES
		fnameServerKEYinsecure="$4.server.key.insecure.pem"
		fnameServerKEY="$4.server.key.pem"
		fnameServerCERT="$4.server.cert.pem"
		#
		fnameServerCSR="$4.server.csr.pem"
		fnameServerCRL="$4.server.crl.pem"
		#
		# USER VARIABLES
		fnameUserKEYinsecure="$4.user.key.insecure.pem"
		fnameUserKEY="$4.user.key.pem"
		fnameUserCERT="$4.user.cert.pem"
		#
		fnameUserCSR="$4.user.csr.pem"
		fnameServerCRL="$4.server.crl.pem"
		#
		...
		# ----------------------------------------------------------------------
		stepName="Creating the $4 USER KEY"
		echo -e "\n\t\tTHE STEP: $stepName\n" 
		#
		createUserKEY
		# ----------------------------------------------------------------------
		stepName="Creating the $4 USER CERT SIGNING REQUEST"
		echo -e "\n\t\tTHE STEP: $stepName\n" 
		#
		createUserCSR
		# ----------------------------------------------------------------------
		stepName="Creating the $4 USER CERTIFICATE"
		echo -e "\n\t\tTHE STEP: $stepName\n" 
		#
		createUserCERT
		# ----------------------------------------------------------------------
		#
		echo -e "\n\t\tYAY!!! FINISHED CREATING USER CERTIFICATE" | tee -a $amklog
